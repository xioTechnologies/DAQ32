...
// Scope library from: http://www.oscilloscope-lib.com/
// Oscilloscope C# wrapper from: Frank Greenlee
    ...
    public partial class Form1 : Form
    {
        ...
        void formUpdateTimer_Tick(object sender, EventArgs e)
        {
            if (daq32 != null)
            {
                ...
                textBox_samplerate.Text = String.Format("{0:0.000}", data.sampleRate);
                textBox_samplePeriod.Text = String.Format("{0:0.000}", 1000.0 / data.sampleRate);
