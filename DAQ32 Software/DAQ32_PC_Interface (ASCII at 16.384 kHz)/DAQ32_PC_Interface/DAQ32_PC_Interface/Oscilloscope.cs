...
**************************************************************************
   ...
   If set to "true", a MessageBox will appear when there is an error.  
...
*/
    ...
    *****************************************/
    ...
    /// Property: ErrorMessagesOn
    /// 
    /// If ErrorMessagesOn is set to "true", a MessageBox will appear 
      ...
      if (_ErrorMessagesOn)
      {
        switch (ErrorNum)
        {
          case SCOPE_CREATION_ERROR:
            MessageBox.Show ("Oscilloscope Creation Failed.", "DLL Communication Error!");
            break;
          case SCOPE_HANDLE_ERROR:
            MessageBox.Show ("Oscilloscope Access Failed.", "DLL Communication Error!");
            break;
          case SCOPE_DISPOSED_ERROR:
            MessageBox.Show ("Oscilloscope has been Disposed.", "DLL Communication Error!");
            break;
          case CAPTIONSIZE_ERROR:
            MessageBox.Show ("Caption Too Long.", "Property Range Error!");
            break;
          case SCOPE_TRIGGERSOURCE_ERROR:
            MessageBox.Show("The Oscilloscope threw a Set Trigger Source Exception and must be Closed.", "DLL Error!");
            break;
          case SCOPE_TRIGGEREDGE_ERROR:
            MessageBox.Show("The Oscilloscope threw a Set Trigger Edge Exception and must be Closed.", "DLL Error!");
            break;
          case SCOPE_NOT_VISIBLE:
            MessageBox.Show("This Property Cannot be Accessed when the Oscilloscope is in Hide Mode.", "DLL Error!");
            break;
        }
      }
    }
      ...
      if (_ErrorMessagesOn)
      {
        switch (ErrorNum)
        {
          case LEFT_RANGE_ERROR: 
            MessageBox.Show (string.Format ("Scope Left Out of Range: {0}.", ErrorValue),
                             "Property Range Error!");
            break;
          case TOP_RANGE_ERROR: 
            MessageBox.Show (string.Format ("Scope Top Out Of Range: {0}.", ErrorValue),
                             "Property Range Error!");
            break;
          case WIDTH_RANGE_ERROR: 
            MessageBox.Show (string.Format ("Scope Width Out of Range: {0}", ErrorValue),
                             "Property Range Error!");
            break;
          case HEIGHT_RANGE_ERROR: 
            MessageBox.Show (string.Format ("Scope Height Out Of Range: {0}.", ErrorValue),
                             "Property Range Error!");
            break;
          case CELLSIZE_RANGE_ERROR: 
            MessageBox.Show (string.Format ("Scope CellSize Out of Range: {0}.", ErrorValue),
                             "Property Range Error!");
            break;
          case TRIGGERSOURCE_RANGE_ERROR:
            MessageBox.Show (string.Format ("Scope Trigger Source Out of Range: {0}.", ErrorValue),
                             "Property Range Error!");
            break;
          case TRIGGERDELAY_RANGE_ERROR:
            MessageBox.Show (string.Format ("Scope Trigger Delay Out of Range: {0}.", ErrorValue),
                             "Property Range Error!");
            break;
      ...
      if (_ErrorMessagesOn)
      {
        switch (ErrorNum)
        {
          case SAMPLESPERGRIDCELL_RANGE_ERROR:
            MessageBox.Show (string.Format ("Scope SamplesPerGridCell Out of Range: {0}", ErrorValue),
                            "PropertyRange Error!");
            break;
          case CELLAMPLITUDESCALE_RANGE_ERROR:
            MessageBox.Show (string.Format ("Scope CellAmplitideScale Out of Range: {0}", ErrorValue),
                            "PropertyRange Error!");
            break;
          case VERTICALOFFSET_RANGE_ERROR:
            MessageBox.Show (string.Format ("Vertical Offset Out of Range: {0}", ErrorValue),
                            "PropertyRange Error!");
            break;
          case TRIGGERLEVEL_RANGE_ERROR:
            MessageBox.Show (string.Format ("Trigger Level Out of Range: {0}", ErrorValue),
                            "PropertyRange Error!");
            break;
        }
      }
